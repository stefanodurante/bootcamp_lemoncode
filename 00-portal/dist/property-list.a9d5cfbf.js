...
exports.mapFilterToQueryParams = exports.mapPropertyListFromApiToViewModel = void 0;
...
var mapPropertyFromApiToViewModel = function mapPropertyFromApiToViewModel(property) {
  return {
    id: property.id,
...
var routes = _objectSpread({}, baseRoutes, {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "56153" + '/');
