...
var CarritoDeLaCompra =
/*#__PURE__*/
function () {
  function CarritoDeLaCompra() {
    _classCallCheck(this, CarritoDeLaCompra);
  ...
  _createClass(CarritoDeLaCompra, [{
    key: "calculaSubtotal",
    value: function calculaSubtotal() {
      ...
      this._subtotal = cesta.reduce(function (acumulado, _ref) {
    ...
    key: "calcularFactorIVA",
    value: function calcularFactorIVA(tipoIVA) {
      switch (tipoIVA) {
        case "general":
          return 1.21;
    ...
    value: function calculateTotal() {
      ...
      this._total = cesta.reduce(function (acumulado, _ref2) {
        var cantidad = _ref2.cantidad,
            precio = _ref2.precio,
            tipoIVA = _ref2.tipoIVA;
        return acumulado + cantidad * precio * _this.calcularFactorIVA(tipoIVA);
      }, 0);
    }
  }, {
    key: "total",
...
var carrito = new CarritoDeLaCompra();
carrito.cesta = cesta;
carrito.subtotal;
