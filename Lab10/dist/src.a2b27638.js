...
var hasId = function hasId(_ref) {
  var id = _ref.id;
  return id ? true : false;
};

console.log(hasId(user)); // head
...
var myArr = ["a", "b", "c", "d"]; //const [first] = myArr
...
var myTailArr = ["uno", 2, true, 3];

var tail = function tail(_ref4) {
  var _ref5 = _toArray(_ref4),
      restItems = _ref5.slice(1);

  return restItems;
};

console.log(tail(myTailArr));
console.log(myTailArr); // swapFirstToLast
...
var mySwapArr = [1, 2, 3, 4];

var swapFirstToLast = function swapFirstToLast(_ref6) {
